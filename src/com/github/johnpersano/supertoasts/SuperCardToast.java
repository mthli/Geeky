...
public class SuperCardToast {
    ...
    public SuperCardToast(Activity activity) {
        ...
        mToastView = mLayoutInflater
                .inflate(R.layout.sct, mViewGroup, false);
    ...
    public SuperCardToast(Activity activity, Type type) {
        ...
        if (type == Type.BUTTON) {
            ...
            mToastView = mLayoutInflater
                    .inflate(R.layout.sct_button, mViewGroup, false);
            ...
            mToastView = mLayoutInflater
                    .inflate(R.layout.sct_progress_circle, mViewGroup, false);
            ...
            mToastView = mLayoutInflater
                    .inflate(R.layout.sct_progress_horizontal, mViewGroup, false);
